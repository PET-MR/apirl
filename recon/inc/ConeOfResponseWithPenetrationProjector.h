/**
	\file ConeOfResponseWithPenetrationProjector.h
	\brief Archivo que contiene la definición de una clase ConeOfResponseWithPenetrationProjector.
...
#ifndef _CONEOFRESPONSEWITHPENETRATIONPROJECTOR_H
#define _CONEOFRESPONSEWITHPENETRATIONPROJECTOR_H

#include <Sinogram2Dtgs.h>
#include <Projector.h> 
#include <Images.h>

class DLLEXPORT ConeOfResponseWithPenetrationProjector : virtual Projector
{
  private:
  ...
  public:
	/** Constructor. */
	ConeOfResponseWithPenetrationProjector(int nSamplesOnDetector, int nSamplesOnCollimatorSurf, float linAttCoef);
