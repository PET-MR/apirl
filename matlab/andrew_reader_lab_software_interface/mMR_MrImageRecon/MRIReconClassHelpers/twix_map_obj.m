...
methods
    ...
    function this = readMDH(this,mdh,filePos)
        ...
        cPar      = mdh.sLC(4)  + 1;         %%% current partition %failsafe
        ...
        this.scancounter(cAcq) = mdh.ulScanCounter;
        this.timestamp  (cAcq) = mdh.ulTimeStamp;
        this.pmutime    (cAcq) = mdh.ulPMUTimeStamp;
