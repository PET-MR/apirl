...
% For gate:
interfilewrite_gate(uint16(reducedPhantom), [outputPath 'actMap_uint16'], pixelSize_mm, 'PointSourcesGridPhantom');
%% MUMAP
...
fclose(fid);
interfilewrite_gate(uint16(tMu_2d_uint16), [outputPath 'muMapWater_uint16'], pixelSize_mm, 'PointSourcesGridPhantom');
...
fclose(fid);
interfilewrite_gate(uint16(tMu_2d_uint16), [outputPath 'muMapAir_uint16'], pixelSize_mm, 'PointSourcesGridPhantom');