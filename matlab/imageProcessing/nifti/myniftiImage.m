% Matlab version modify to work with different nifti versions.
classdef myniftiImage < handle
    ...
    methods 
        ...
        %    the object. It returns the image as a numeric vector 'img'.
            ...
            if fid > 0
                ...
                %% BUG FIX BY MARTIN BELZUNCE 2017-07-14
                % original: imageSize = prod(headerStruct.dim(2:8));
                % new:
                numDims = headerStruct.dim(1);
                imageSize = prod(headerStruct.dim(2:2+numDims-1));
                ...
                % remove squeeze.
                img = (reshape(img, headerStruct.dim(2:2+numDims-1)));
                if isempty(img)
