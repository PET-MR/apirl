...
baseDicomFilename = '';
[mrRescaled, petImage, refMrRescaled] = RemapMrIntoPetImageSpace(interfileHeaderPet, pathMrDicom, baseDicomFilename, 1);
...
for i = 1 : numel(baseDicomFilename)
    [mrRescaled, petImage, refMrRescaled] = RemapMrIntoPetImageSpace(interfileHeaderPet, pathMrDicom, baseDicomFilename{i}, 1);
