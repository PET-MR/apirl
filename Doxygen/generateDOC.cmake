...
# Modified by Martín Belzunce 2010
...
# Seteo en la variable DOXY_ENCODING el formato de codificación ASCII,
# ya que en Windows es distinto al de Linux, teniendo problemas de compatibilidad
# con los caracteres especiales (especialmente los acentos).
IF (WIN32)
	SET(DOXY_ENCODING "ISO-8859-1")
ELSE()
	SET(DOXY_ENCODING "UTF-8")
ENDIF()
...
INSTALL(DIRECTORY "${PROJECT_BINARY_DIR}/doc/html/" DESTINATION "${APIRL_INSTALL_PATH}/doc/${PROJECT_NAME}" )
