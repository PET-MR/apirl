...
// se recorre desde P0 a P1.
  ...
  i_min = floor((x_1_mm + d_RadioFov_mm)/d_imageSize.sizePixelX_mm); // In X increase of System Coordinate = Increase Pixels.
  j_min = floor((y_1_mm + d_RadioFov_mm)/d_imageSize.sizePixelY_mm); 
  k_min = floor((z_1_mm - offsetZ_mm)/d_imageSize.sizePixelZ_mm); 
